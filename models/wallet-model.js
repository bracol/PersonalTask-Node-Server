...
var mongoose = require ('mongoose'),
  walletSchema = new mongoose.Schema({
    value: {type: mongoose.Schema.Types.Number, required: true, trim: true},
    login_id: { type: mongoose.Schema.Types.ObjectId, required: true, trim: true},
